...
const AddBlog = () => {
  ...
  return (
    <div className='w-full'>
      <form onSubmit={onSubmitHandler} className='flex-1 w-full bg-green-50/50 text-gray-600 h-full overflow-scroll'>
        <div className='bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded'>
          ...
          <select onChange={e => setCategory(e.target.value)} name="category"className='mt-2 px-3 py-2 border  text-gray-500border-gray-300 outline-none rounded ' >
